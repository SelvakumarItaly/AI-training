...
base_folder = r"E:\Thesis - Writing Selva\LR\Litrature Review"  # Change this to your folder path
data = extract_info_from_folders(base_folder)

# Specify the output directory
output_dir = r"E:\Thesis - Writing Selva\LR\Litrature Review\output1"  # Change this to your desired output directory

# Ensure the output directory exists
os.makedirs(output_dir, exist_ok=True)

# Save the output files in the specified directory
save_to_excel(data, os.path.join(output_dir, "output.xlsx"))
save_to_txt(data, os.path.join(output_dir, "output.txt"))
